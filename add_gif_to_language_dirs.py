...
def main():
    print("🎬 开始为其他语言目录添加GIF演示...")
    print("=" * 80)
    
    # 要处理的目录
    language_dirs = ['kr', 'jp', 'tw', 'zh-CN']
    ...
    for lang_dir in language_dirs:
        ...
        # 排除v3页面和blog页面
        all_pages = [p for p in all_pages if 'v3.html' not in str(p) and '/blog/' not in str(p)]
        ...
        print(f"\n{lang_dir}/ 完成: ✅ {success_count} | ⏭️ {skip_count} | ❌ {error_count}")
