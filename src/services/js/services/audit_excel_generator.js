    ...
    generateAndDownload(records, companyName) {
        ...
        records.forEach(record => {
            ...
            wsData.push([
                ...
                record.merchantName,
                ((_a = record.taxMapping) === null || _a === void 0 ? void 0 : _a.label_zh) || record.category,
                ((_b = record.taxMapping) === null || _b === void 0 ? void 0 : _b.ird_tag) || 'N/A',
                record.amount.toFixed(2),
                ((_c = record.taxMapping) === null || _c === void 0 ? void 0 : _c.deductible) ? '是 (Yes)' : '否 (No)',
