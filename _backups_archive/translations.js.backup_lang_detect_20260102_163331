...
const translations = {
    'en': {
        ...
        'delete_project_warning': 'This action cannot be undone. All content in this project will be permanently deleted.',
        'delete_project_input_hint': 'Enter project name to confirm deletion',
        'yes_delete': 'Yes, Delete',
        'create_new_project': 'Create New Project',
        'create_project_description': 'Enter a project name to create a new document project',
        ...
        'delete_account_warning': 'Deleting your account will permanently remove all your data, including projects, documents and settings. This action cannot be undone.',
    ...
    'zh-TW': {
        ...
        'delete_project_title': '刪除專案',
        'delete_project_confirm': '是否刪除專案',
        'delete_project_warning': '刪除後無法復原專案及當中內容。',
        'delete_project_input_hint': '輸入專案名稱以確認刪除',
        'yes_delete': '是',
        'create_new_project': '建立新專案',
        'create_project_description': '輸入專案名稱以建立新的文檔專案',
        'project_name': '專案名稱',
        'create': '建立',
        'cancel': '取消',
        'manage_profile_desc': '管理您的個人資料和帳戶設定',
        'current_plan': '目前方案',
        'next_billing': '下次計費：',
        'current_password': '目前密碼',
        'new_password': '新密碼',
        'password_requirement': '密碼至少需要 8 個字元',
        'confirm_new_password': '確認新密碼',
        'update_password': '更新密碼',
        'timezone': '時區',
        'save_settings': '儲存設定',
        'delete_account_warning': '刪除您的帳戶將永久刪除所有資料，包括專案、文件和設定。此操作無法復原。',
        'delete_account': '刪除帳戶',
        'loading_records': '載入記錄中...',
    ...
    'ja': {
        ...
        'delete_project_confirm': 'プロジェクトを削除してもよろしいですか',
        'delete_project_warning': '削除後は復元できません。このプロジェクトのすべてのコンテンツが完全に削除されます。',
        'delete_project_input_hint': 'プロジェクト名を入力して削除を確認',
        'yes_delete': 'はい、削除します',
        'create_new_project': '新しいプロジェクトを作成',
        'create_project_description': 'プロジェクト名を入力して新しいドキュメントプロジェクトを作成',
        'project_name': 'プロジェクト名',
        'create': '作成',
        'cancel': 'キャンセル',
        'manage_profile_desc': 'プロフィールとアカウント設定を管理',
        'current_plan': '現在のプラン',
        'next_billing': '次回請求：',
        'current_password': '現在のパスワード',
        'new_password': '新しいパスワード',
        'password_requirement': 'パスワードは8文字以上である必要があります',
        'confirm_new_password': '新しいパスワードを確認',
        'update_password': 'パスワードを更新',
        'timezone': 'タイムゾーン',
        'save_settings': '設定を保存',
        'delete_account_warning': 'アカウントを削除すると、プロジェクト、ドキュメント、設定を含むすべてのデータが完全に削除されます。この操作は元に戻せません。',
        'delete_account': 'アカウントを削除',
        'loading_records': 'レコードを読み込み中...',
    ...
    'ko': {
        ...
        'delete_project_confirm': '프로젝트를 삭제하시겠습니까',
        'delete_project_warning': '삭제 후 복원할 수 없습니다. 이 프로젝트의 모든 콘텐츠가 영구적으로 삭제됩니다.',
        'delete_project_input_hint': '프로젝트 이름을 입력하여 삭제 확인',
        'yes_delete': '예, 삭제합니다',
        'create_new_project': '새 프로젝트 만들기',
        'create_project_description': '프로젝트 이름을 입력하여 새 문서 프로젝트 만들기',
        'project_name': '프로젝트 이름',
        'create': '만들기',
        'cancel': '취소',
        'manage_profile_desc': '프로필 및 계정 설정 관리',
        'current_plan': '현재 플랜',
        'next_billing': '다음 청구:',
        'current_password': '현재 비밀번호',
        'new_password': '새 비밀번호',
        'password_requirement': '비밀번호는 최소 8자 이상이어야 합니다',
        'confirm_new_password': '새 비밀번호 확인',
        'update_password': '비밀번호 업데이트',
        'timezone': '시간대',
        'save_settings': '설정 저장',
        'delete_account_warning': '계정을 삭제하면 프로젝트, 문서, 설정을 포함한 모든 데이터가 영구적으로 삭제됩니다. 이 작업은 취소할 수 없습니다.',
        'delete_account': '계정 삭제',
        'loading_records': '기록 로드 중...',
